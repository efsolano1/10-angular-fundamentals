...
@Component({
  ...
  imports: [MainImageComponent, ContainerImagesComponent, SliderComponent, BackgroundHeaderComponent, BackgroundContentComponent, BackgroundFooterComponent],
  standalone: true,
...
export class MainSectionComponent {
  ...
  public containerImage1=1;
  public containerImage2=2;
}
